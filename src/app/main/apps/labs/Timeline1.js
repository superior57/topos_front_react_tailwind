...
import TimeLine from "../../generics/components/timeline-gantt/TimeLine";
...
class App extends Component {
  constructor(props) {
    super(props);
    let result = Generator.generateDataTopos();
  ...
  handleDayWidth = e => this.setState({ daysWidth: parseInt(e.target.value) });

  handleItemHeight = e => this.setState({ itemheight: parseInt(e.target.value) });

  modeChange = value => this.setState({ timelineMode: value });
    ...
    return (
      <div className="app-container">
        <div className="nav-container">
          <div className="mode-container-title">Timeline</div>
          <div className="operation-button-container">
            <div className="operation-button-container">
              ...
              <div className="mode-button" onClick={this.delTask}>
                <svg height={30} width={30} viewBox="0 0 48 48">
                  <path
                    fill="silver"
